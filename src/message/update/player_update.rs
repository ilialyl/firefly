...
use crate::{
    message::{Message, PlayerMessage, cmd::player_cmd::*},
    model::Model,
};
...
pub fn update_player(
    ...
    match msg {
        ...
        PlayerMessage::Skip => skip(model, msg_tx, info_tx),
        PlayerMessage::PreviousTrack => previous_track(model, msg_tx, info_tx),
