...
pub fn update_queue(
    ...
    match msg {
        QueueMessage::Clear => clear_queue(&mut model.player),
        ...
        QueueMessage::RemoveSelected => remove_selected_queued_track(&mut model.player),
        ...
        QueueMessage::Shuffle => shuffle_queue(&mut model.player),
